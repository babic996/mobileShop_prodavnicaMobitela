...
@section('navbar')
    ...
    @section('products')
        <div class="col-md-4 mt-3">
            <form method="get" action="{{route('filter.tablet',$id)}}">
                                ...
                                @foreach($tablets as $tablet)
                                    <div class="col-md-8 col-lg-6 col-xl-4">
                                        <div class="card text-black">
                                            <img
                                                src="{{URL('storage/images/'.$tablet->image_name)}}"
                                                class="img img-small p-5"
                                                alt="Slika"
                                            />
                                            <div class="card-body">
                                                <div class="text-center" style="height: 60px">
                                                    <h5 class="card-title"><a href="{{route('tablet.index.show',$tablet->id)}}" class="product-name">{{$tablet->name}}</a></h5>
                                                </div>
                                                <div>
                                                    <div class="d-flex justify-content-between total font-weight-bold mt-4">
                                                        <h5>Cijena</h5><h5>{{$tablet->price}}KM</h5>
                                                    </div>

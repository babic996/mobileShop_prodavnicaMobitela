...
@section('navbar')
    ...
    @section('products')
        <div class="col-md-4 mt-3">
            <form method="get" action="{{route('filter.equipment',$id)}}">
                                ...
                                <!-- Product -->
                                    <div class="col-md-8 col-lg-6 col-xl-4">
                                        <div class="card text-black">
                                            <img
                                                src="{{URL('storage/images/'.$equipment->image_name)}}"
                                                class="img img-small p-5"
                                                alt="Slika"
                                            />
                                            <div class="card-body">
                                                <div class="text-center" style="height: 60px">
                                                    <h5 class="card-title"><a href="{{route('equipment.index.show',$equipment->id)}}" class="product-name">{{$equipment->name}}</a></h5>
                                                </div>
                                                <div>
                                                    <div class="d-flex justify-content-between total font-weight-bold mt-4">
                                                        <h5>Cijena</h5><h5>{{$equipment->price}}KM</h5>
                                                    </div>
                                                    <div class="d-flex justify-content-center">
                                                        <span class="product-price mt-5">
                                                            <form method="get" action="{{route('equipment.addToCart',$equipment->id)}}">
